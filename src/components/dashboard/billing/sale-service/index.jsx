...
const ProductForm = () => {
    ...
    const handleSubmit = (e) => {
        ...
        console.log("hi this is submit form =======>", formData);
    }
    ...
    return (
        <div className="container mt-4">
            <Form onSubmit={handleSubmit}>
                ...
                <Row className="mt-2 g-3">
                    <Col md={2}><Form.Label>Discount %</Form.Label><Form.Control type="number" min="0" value={maxDiscount} onChange={handleNumericInput(setMaxDiscount)} /></Col>
                    <Col md={2}><Form.Label>SGST %</Form.Label><Form.Control type="number" min="0" value={sgstPercent} onChange={handleNumericInput(setSgstPercent)} /></Col>
                    <Col md={2}><Form.Label>CGST %</Form.Label><Form.Control type="number" min="0" value={cgstPercent} onChange={handleNumericInput(setCgstPercent)} /></Col>
                    <Col md={2}><Form.Label>IGST %</Form.Label><Form.Control type="number" min="0" value={igstPercent} onChange={handleNumericInput(setIgstPercent)} /></Col>
                    <Col md={2}><Form.Label>HSN/SAC</Form.Label><Form.Control type="text" value={hsn} onChange={e => setHsn(e.target.value)} /></Col>
                    <Col md={2}>
