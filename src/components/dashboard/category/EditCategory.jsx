...
//                 setTimeout(() => {
//                     router.push('/admin/service-list'); // Redirect after a successful response
//                 }, 500);
//             }
...
//                 <h5 className="mb-4">Edit Caegory </h5>
...
import { useUpdateCategoryMutation, useGetCategoryByIdQuery } from '../../../store/features/category/categoryApi';
...
const EditCategoryForm = () => {
    ...
    const { data: category, isLoading: isFetching, isError: isFetchError, error: fetchError } = useGetCategoryByIdQuery(id);
    ...
    const [updateCategory, { isLoading: isUpdating, isError: isUpdateError, error: updateError }] = useUpdateCategoryMutation();
